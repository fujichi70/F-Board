...
$sql = 'SELECT recipe_boards.id, recipe_boards.user_id, recipe_boards.text, recipe_boards.created_at, recipe_boards.deleted_flag, users.name, users.img_path FROM users INNER JOIN recipe_boards ON users.id = recipe_boards.user_id WHERE deleted_flag=0 ORDER BY created_at DESC';
...
<head>
	...
	<title>F Free Board - レシピ相談</title>
...
<body>
	...
	<div class="category-box">
		<div class="recipe-text"><h1 class="common-text">毎日の献立作りで悩んでいる皆さんでアイディアを出し合いましょう！</h1></div>
		<div class="category-img--parts"><img class="category-img" src="img/recipe.jpg" alt=""></div>
	</div>

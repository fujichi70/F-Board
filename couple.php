...
$sql = 'SELECT couple_boards.id, couple_boards.user_id, couple_boards.text, couple_boards.created_at, couple_boards.deleted_flag, users.name, users.img_path FROM users INNER JOIN couple_boards ON users.id = couple_boards.user_id WHERE deleted_flag=0 ORDER BY created_at DESC';
...
<head>
	...
	<title>F Free Board - 夫婦生活相談</title>
...
<body>
	...
	<div class="category-box">
		<div class="couple-text"><h1 class="common-text">夫婦生活や夫婦関係にお悩みを持つ皆さんで相談しあいましょう！</h1></div>
		<div class="category-img--parts"><img class="category-img" src="img/couple.jpg" alt="夫婦画像"></div>
	</div>
					...
					<?php if (!empty($_SESSION['id'])) :
						if ($_SESSION['id'] === $row['user_id']) : ?>
							<form action="deleted.php" method="post">
								...
								<input type="hidden" name="category" value="couple">

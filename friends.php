...
$sql = 'SELECT friends_boards.id, friends_boards.user_id, friends_boards.text, friends_boards.created_at, friends_boards.deleted_flag, users.name, users.img_path FROM users INNER JOIN friends_boards ON users.id = friends_boards.user_id WHERE deleted_flag=0 ORDER BY created_at DESC';
...
<head>
	...
	<title>F Free Board - 友人関係相談</title>
...
<body>
	...
	<div class="category-box">
		<div class="friends-text"><h1 class="common-text">友人との関係にお悩みを持つ皆さんで相談しあいましょう！</h1></div>
		<div class="category-img--parts"><img class="category-img" src="img/friends.jpg" alt=""></div>
	</div>
					...
					<?php if (!empty($_SESSION['id'])) :
						if ($_SESSION['id'] === $row['user_id']) : ?>
							<form action="deleted.php" method="post">
								...
								<input type="hidden" name="category" value="friends">

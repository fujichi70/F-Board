...
$sql = 'SELECT love_boards.id, love_boards.user_id, love_boards.text, love_boards.created_at, love_boards.deleted_flag, users.name, users.img_path FROM users INNER JOIN love_boards ON users.id = love_boards.user_id WHERE deleted_flag=0 ORDER BY created_at DESC';
...
<body>
	...
	<div class="category-box">
		<div class="love-text"><h1 class="common-text">片思いや恋人のことで悩んでいる皆さんでアイディアを出し合いましょう！</h1></div>
		<div class="category-img--parts"><img class="category-img" src="img/love.jpg" alt="恋愛系画像"></div>
	</div>
